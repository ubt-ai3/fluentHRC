...
void hand_pose_test::show_hand_keypoints(std::shared_ptr<pcl::visualization::PCLVisualizer>& viewer,
	const kinect2_parameters& kinect2_params,
...
Eigen::Matrix<float, 3, 4> hand_pose_test::projection_matrix(const kinect2_parameters& kinect2_params,
...
void hand_pose_test::show_projection(kinect2_parameters& kinect2_params, const visual_input& input) const
{
