...
bool CColorBasics::SetStatusMessage(_In_z_ const WCHAR* szMessage, DWORD nShowTimeMsec, bool bForce)
{
...
HRESULT CColorBasics::GetScreenshotFileName(_Out_writes_z_(nFilePathSize) LPWSTR lpszFilePath, UINT nFilePathSize)
{
    ...
    HRESULT hr = SHGetKnownFolderPath(FOLDERID_Pictures, 0, nullptr, &pszKnownPath);
